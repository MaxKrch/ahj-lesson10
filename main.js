...
;// CONCATENATED MODULE: ./src/js/data/AppState.js
class State {
  constructor() {
    this.tempMedia = [];
    this.listNotes = [];
...
;// CONCATENATED MODULE: ./src/js/ui/Panels.js
...
class Panels {
  ...
  updateTimeRecord(time) {
    const timeForPage = moment_default()(time, 's').format('mm:ss');
    this.record.controll.info.textContent = timeForPage;
  }
}
;// CONCATENATED MODULE: ./src/js/ui/Modals.js
class Modals {
  constructor() {
    this.container;
    this.confirm = {
...
;// CONCATENATED MODULE: ./src/js/ui/Note.js
...
class NoteEl {
  ...
  renderTimeBlock(time) {
    ...
    const formatedTime = moment_default()(time).locale('ru').format('DD.MM.YY HH:MM');
...
;// CONCATENATED MODULE: ./src/js/ui/AppRender.js
...
;// CONCATENATED MODULE: ./src/js/api/Media.js
class MediaAPI {
...
;// CONCATENATED MODULE: ./src/js/api/Geolocation.js
...
;// CONCATENATED MODULE: ./src/js/api/Note.js
class NoteObj {
  constructor(data) {
